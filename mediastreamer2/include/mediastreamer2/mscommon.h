...
typedef struct _MSRtspSubSession MSRtspSubSession;
...
// added by liuhong for rtsp start
MS2_PUBLIC MSList *ms_rtsp_connect(const char *rtsp_url, int video_port, int audio_port, char *dest_addr, void **remote_rtsp_client, void **remove_rtsp_mediasession);
MS2_PUBLIC void ms_rtsp_disconnect(void *remote_rtsp_client, void *remove_rtsp_mediasession);
MS2_PUBLIC void ms_rtsp_play(void *remote_rtsp_client, void *remove_rtsp_mediasession);
// added by liuhong for rtsp end
#undef MIN
