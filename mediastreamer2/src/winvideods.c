...
static int v4w_configure_videodevice(V4wState *s)
{
	...
	else if (try_format_size(s, s->pix_fmt, MS_VIDEO_SIZE_WVGA_W, MS_VIDEO_SIZE_WVGA_H, &pPinCategory)==0)
		ms_message("Selected Size: %ix%i.", MS_VIDEO_SIZE_WVGA_W, MS_VIDEO_SIZE_WVGA_H);
